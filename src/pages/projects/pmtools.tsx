        ...
        <div className="w-full max-w-[800px]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="w-full relative min-h-[250px]">
                  <Image src='/img/pmtools/pm-detail.png' fill className="object-cover rounded-3xl"></Image>
              </div>
          ...
          <div className="mb-10">
            ...
            <div className="w-full relative min-h-[250px] sm:min-h-[500px]">
                <Image src='/img/pmtools/pm-userflow.png' fill className="object-cover rounded-3xl"></Image>
            </div>
          </div>
          ...
          <div className="mb-10">
            ...
            <div className="w-full relative min-h-[250px] sm:min-h-[500px] mb-4">
                <Image src='/img/pmtools/pm-wireframe1.png' fill className="object-cover rounded-3xl"></Image>
            </div>
            <div className="w-full relative min-h-[250px] sm:min-h-[500px] mb-4">
                <Image src='/img/pmtools/pm-wireframe2.png' fill className="object-cover rounded-3xl"></Image>
            </div>
            <div className="w-full relative min-h-[250px] sm:min-h-[500px] mb-4">
                <Image src='/img/pmtools/pm-wireframe3.png' fill className="object-cover rounded-3xl"></Image>
            </div>
            <div className="w-full relative min-h-[250px] sm:min-h-[500px] mb-4">
                <Image src='/img/pmtools/pm-wireframe4.png' fill className="object-cover rounded-3xl"></Image>
            </div>
          </div>
          {/* Mockup */}
          <div className="mb-10">
            ...
            <div className="w-full relative min-h-[250px] sm:min-h-[500px] mb-4">
                <Image src='/img/pmtools/pm-mockup1.png' fill className="object-cover rounded-3xl"></Image>
            </div>
            <div className="w-full relative min-h-[250px] sm:min-h-[500px] mb-4">
                <Image src='/img/pmtools/pm-mockup2.png' fill className="object-cover rounded-3xl"></Image>
            </div>
            <div className="w-full relative min-h-[250px] sm:min-h-[500px] mb-4">
                <Image src='/img/pmtools/pm-mockup3.png' fill className="object-cover rounded-3xl"></Image>
            </div>
            <div className="w-full relative min-h-[250px] sm:min-h-[500px] mb-4">
                <Image src='/img/pmtools/pm-mockup4.png' fill className="object-cover rounded-3xl"></Image>
            </div>
          </div>
        </div>
      </div>
