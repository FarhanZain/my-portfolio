...
export default function UiTracerStudy() {
      ...
      <div className="container mx-auto p-4 flex flex-col items-center sm:py-10 h-screen w-full">
        ...
        <div className="w-full max-w-[800px]">
          ...
          <div className="mb-10">
            ...
            <p className="mb-5">This project is a personal project about a tracer study web application, in this application can monitor alumni statistics and manage questionnaire data.</p>
          </div>
          {/* Mockup */}
          <div className="mb-10">
            <h1 className="text-2xl font-semibold mb-4">Mockup</h1>
            <img
                src="/img/tracer/tracer-mockup.png"
