        ...
        <div className="w-full max-w-[800px]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="w-full relative min-h-[250px]">
                  <Image src='/img/snorkeling/snorkeling-detail.png' fill className="object-cover rounded-3xl"></Image>
              </div>
          ...
          <div className="mb-10">
            ...
            <div className="w-full relative min-h-[250px] sm:min-h-[500px] mb-4">
                <Image src='/img/snorkeling/snorkeling-mockup.png' fill className="object-cover rounded-3xl"></Image>
            </div>
          </div>
        </div>
      </div>
